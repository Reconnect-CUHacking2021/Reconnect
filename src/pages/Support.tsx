  ...
  return (
    <IonPage id="support-page">
      ...
      <IonContent>
        ...
        <form noValidate onSubmit={send} style={{ padding: '0px 36px' }}>
          <IonList>
            <IonItem>
              <IonLabel position="stacked" color="primary">Enter your support message below</IonLabel>
              <IonTextarea style={{ border: '1px solid #e4e4e4', borderRadius: '4px', marginBottom: '24px' }} name="message" value={message} spellCheck={false} autocapitalize="off" rows={6} onIonChange={e => setMessage(e.detail.value!)}
                required>
              </IonTextarea>
            </IonItem>
